...
def main():
    ...
    client_list.add_argument("--nome", default="", help="Filtrar pelo nome")
    ...
    bud_list.add_argument("--descricao", help="Filtrar por trecho da descricao")
    ...
    if args.cmd == "add":
        ...
        for c in db.listar_clientes(args.nome):
            cnpj = c[2] or "-"
        ...
        for b in db.listar_orcamentos(resultado=args.resultado, aprovado=args.aprovado, cliente=args.cliente, descricao=args.descricao):
